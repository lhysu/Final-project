...
// 	}
 	...
 	@GetMapping("/admin/review/update")
 	public String updateAdmin(ReviewVO vo, Model model) {
 		log.info("/admin/review/update");
 		log.info("vo:{}", vo);
 	...
 	@GetMapping("/admin/review/selectAll")
 	public String selectAllAdmin(Model model, @RequestParam(defaultValue = "1") int cpage,
...
// 		List<MemberVO> list = service.selectAll();
 		...
 		list = service.selectAllPageBlockAdmin(cpage, pageBlock);// 해당페이지에 보여줄 5개행씩만 검색
 		...
 		int total_rows = service.getTotalRowsAdmin();// select count(*) total_rows from member;
...
// 	}
 	...
 	@GetMapping("/admin/review/searchList")
 	public String searchList(Model model, @RequestParam(defaultValue = "member_id") String searchKey,
 			@RequestParam(defaultValue = "") String searchWord,
 			@RequestParam(defaultValue = "1") int cpage,
 			@RequestParam(defaultValue = "10") int pageBlock) {
 		log.info("/admin/review/searchList");
...
// 	}
 	...
 	@GetMapping("/admin/review/selectOne")
 	public String selectOneAdmin(ReviewVO vo, Model model) {
 		log.info("/admin/review/selectOne");
 		log.info("vo:{}", vo);
...
// 	}
 	...
 	@PostMapping("/admin/review/updateOK")
 	public String updateOKAdmin(ReviewVO vo) throws IllegalStateException, IOException {
 		log.info("/admin/review/updateOK");
 		log.info("vo:{}", vo);
 		...
 		if (result == 1) {
 			...
 			return "redirect:/admin/review/update?review_num=" + vo.getReview_num();
 		}
 	}
...
// 	}
 	...
 	@PostMapping("/admin/review/deleteOK")
 	public String deleteOKAdmin(ReviewVO vo) {
 		log.info("/admin/review/deleteOK");
 		log.info("vo:{}", vo);
 		...
 		if (result == 1) {
 			...
 			return "redirect:/admin/review/delete?review_num=" + vo.getReview_num();
 		}
 	}
