...
//		List<RecycleLifeCommentVO> list = service.selectAll();
	...
	@GetMapping("/community/recycleLifeComment/insertOK")
	public String insertOK(RecycleLifeCommentVO vo) {
		...
		if(result == 1) {
			...
			return "redirect:/community/recycleLifeComment/insert";
		}				
	}
	
	@GetMapping("/community/recycleLifeComment/deleteOK")
	public String deleteOK(RecycleLifeCommentVO vo) {
		...
		if(result == 1) {
			...
			return "redirect:/community/recycleLifeComment/delete?recycleLife_num=" + vo.getRecycleLife_num();
		}			
	}
	
	@GetMapping("/community/recycleLifeComment/updateOK")
	public String updateOK(RecycleLifeCommentVO vo) {
		...
		if(result == 1) {
			...
			return "redirect:/community/recycleLifeComment/update?recycleLife_num=" + vo.getRecycleLife_num();
		}
